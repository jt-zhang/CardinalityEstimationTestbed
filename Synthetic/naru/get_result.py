...
for version in ['cols_4_distinct_10_corr_6_skew_6']:
    ...
    # train
    os.system('python train_model.py --version '  + version + ' --num-gpus=1 --dataset=dmv --epochs=60 --warmups=8000 --bs=2048 --residual --layers=5 --fc-hiddens=256 --direct-io --column-masking')
    ...
    # test
    os.system('python eval_model.py --testfilepath /home/jintao/naru/sql_truecard/ --version '  + version + ' --table '  + version + ' --alias cdcs --dataset=dmv --glob=\'<ckpt from above>\' --num-queries=1000 --residual --layers=5 --fc-hiddens=256 --direct-io --column-masking')
