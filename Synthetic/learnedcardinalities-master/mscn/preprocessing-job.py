...
def get_col_statistics(cols, data_dir):
    alias2table = {'ci':'cast_info', 'mc':'movie_companies', 'mi':'movie_info', 'mk':'movie_keyword', 'mi_idx':'movie_info_idx', 't':'title'}
    names = []
    cards = []
    distinct_nums = []
    mins = []
...
def select_samples(data_dir):
    table2alias = {'cast_info': 'ci', 'movie_companies': 'mc', 'movie_info': 'mi', 'movie_keyword': 'mk', 'movie_info_idx': 'mi_idx', 'title': 't'}
    samples = {}
