...
df1 = pd.read_csv( '/home/zhangjintao/DeepDB/ranges/imdb-benchmark/ranges_sample_0.15*2_0.03_join.csv', sep=',', escapechar='\\', encoding='utf-8', low_memory=False, quotechar='"')
...
for i in df1.columns.values:
    for j in df1.columns.values:
        ...
        str_write = i + ' & ' + j + ' chi2 is: ' + str_score  + '  lenx: ' + str_len_x + '  leny: ' + str_len_y + ' crit0.99: '+ str(crit) +'\n'
        # print(str_write)
        f2.write(str_write)
