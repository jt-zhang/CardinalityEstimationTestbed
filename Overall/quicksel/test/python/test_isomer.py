...
def test_nodes5():
    ...
    print n1.total_vol(), n1.exclusive_vol()
...
def test_toy():
    ...
    print isomer.answer({0:[0, 1], 1:[0, 1]})
    print isomer.answer({0:[1, 2], 1:[0, 1]})
    print isomer.answer({0:[0, 1], 1:[1, 2]})
    print isomer.answer({0:[1, 2], 1:[1, 2]})

    print isomer.answer({0:[0, 2], 1:[0, 1]})
    print isomer.answer({0:[0, 2], 1:[1, 2]})
    print isomer.answer({0:[0, 1], 1:[0, 2]})
    print isomer.answer({0:[1, 2], 1:[0, 2]})
