...
df_title = pd.read_csv( '.../train-test-data/imdb-distinct-data/high/title.csv', sep=',', escapechar='\\', encoding='utf-8',
                       low_memory=False, quotechar='"')

df_cast_info = pd.read_csv( '.../train-test-data/imdb-distinct-data/high/cast_info.csv', sep=',', escapechar='\\', encoding='utf-8',
