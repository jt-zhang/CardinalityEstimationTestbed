...
python3 maqp.py --evaluate_cardinalities --rdc_spn_selection --max_variants 1 --pairwise_rdc_path ../imdb-benchmark/spn_ensembles/pairwise_rdc.pkl --dataset imdb-ranges --target_path /home/zhangjintao/Benchmark3/otherdataset/csvdata_sql/foresttest.sql.deepdb.results.csv --ensemble_location /home/zhangjintao/Benchmark3/otherdataset/csvdata_sql/forest.sql.deepdb.model.pkl --query_file_location ../train-test-data/forest_power-sql/foresttest.sql --ground_truth_file_location ./benchmarks/job-light/sql/true_cardinalities.csv --version forest
