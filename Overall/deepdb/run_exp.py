...
if cols == 2:
    ...
    os.system('python3 maqp.py --csv_path ../../../train-test-data/imdbdata-num/no_head --generate_hdf --generate_sampled_hdfs --generate_ensemble --dataset cols2')
    ...
    os.chdir('./deepdb-imdb/deepdb_job_ranges')
    os.system('python3 maqp.py --csv_path ../../../train-test-data/imdbdata-num/no_head --generate_hdf --generate_sampled_hdfs --generate_ensemble --dataset cols4')
    ...
    os.chdir('./deepdb-imdb/deepdb_job_ranges')
    os.system('python3 maqp.py --csv_path ../../../train-test-data/imdbdata-num/no_head --generate_hdf --generate_sampled_hdfs --generate_ensemble --dataset cols6')
    ...
    os.chdir('./deepdb-imdb/deepdb_job_ranges')
    os.system('python3 maqp.py --csv_path ../../../train-test-data/imdbdata-num/no_head --generate_hdf --generate_sampled_hdfs --generate_ensemble --dataset cols8')
...
# XTZX
    ...
    os.chdir('./deepdb-imdb/deepdb_job_ranges')
    os.system('python3 maqp.py --csv_path ../../../train-test-data/xtzx-data-sql/no_head --generate_hdf --generate_sampled_hdfs --generate_ensemble --dataset xt2')
    os.system('python3 maqp.py --csv_path ../../../train-test-data/xtzx-data-sql/no_head --evaluate_cardinalities --rdc_spn_selection --max_variants 1 --target_path ./baselines/cardinality_estimation/results/deepdblight/imdb_light_model_based_budget_5.csv --ensemble_location ../imdb-benchmark/spn_ensembles/ensemble_join_3_budget_5_10000000.pkl --query_file_location ../../../train-test-data/xtzx-data-sql/2/test-2-num.sql --ground_truth_file_location ./benchmarks/job-light/sql/true_cardinalities.csv --dataset xt2')
    os.chdir('..')

elif xt == 4:
    os.chdir('./deepdb-imdb/deepdb_job_ranges')
    os.system('python3 maqp.py --csv_path ../../../train-test-data/xtzx-data-sql/no_head --generate_hdf --generate_sampled_hdfs --generate_ensemble --dataset xt4')
    ...
    os.chdir('./deepdb-imdb/deepdb_job_ranges')
    os.system('python3 maqp.py --csv_path ../../../train-test-data/xtzx-data-sql/no_head --generate_hdf --generate_sampled_hdfs --generate_ensemble --dataset xt6')
    ...
    os.chdir('./deepdb-imdb/deepdb_job_ranges')
    os.system('python3 maqp.py --csv_path ../../../train-test-data/xtzx-data-sql/no_head --generate_hdf --generate_sampled_hdfs --generate_ensemble --dataset xt8')
    ...
    os.chdir('./deepdb-imdb/deepdb_job_ranges')
    os.system('python3 maqp.py --csv_path ../../../train-test-data/xtzx-data-sql/no_head --generate_hdf --generate_sampled_hdfs --generate_ensemble --dataset xt10')
