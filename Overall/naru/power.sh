python train_model.py --csvname power.csv --num-gpus=1 --dataset=power --epochs=1 --warmups=8000 --bs=2048 --residual --layers=5 --fc-hiddens=256 --direct-io --column-masking
